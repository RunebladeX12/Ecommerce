...
// Function to initialize the zoom plugin with the correct image URL
    (function (o) {
        var t = {
            url: !1,
            callback: !1,
        ...
        o.fn.zoom = function (n) {
            return this.each(function () {
                ...
                if (!e.url) {
                    ...
                    if (f && (e.url = product.image.dataSrc || f.getAttribute("data-src") || f.currentSrc || f.src), !e.url) return;
                }
